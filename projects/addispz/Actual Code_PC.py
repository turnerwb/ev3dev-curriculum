...
def main():
    my_delegate_homie = MyDelegate()
    mqtt_client = com.MqttClient(my_delegate_homie)
...
class MyDelegate(object):
    ...
    def pc_window(self):
        ...
        main_frame.grid()
        Water_Found = ttk.Label(main_frame, text="Water Found")
        Water_Found.grid(row=3, column=2)
