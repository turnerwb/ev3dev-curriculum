...
def main():
    ...
    while True:
        ...
        if left_sp or distance_in != 0:
            degrees_per_inch = 90
            motor_turns_needed_in_degrees = distance_in * degrees_per_inch
            left_motor.run_to_rel_pos(position_sp=motor_turns_needed_in_degrees, speed_sp=left_sp)
            right_motor.run_to_rel_pos(position_sp=motor_turns_needed_in_degrees, speed_sp=left_sp)
