...
Note: In future modules you will learn different (BETTER) ways to drive a given distance.
...
#     400 degrees / second  -->  traveled 44.25 inches  -->  4.425 inches / second
#   Tests @ 5 seconds:
...
#     900 degrees / second  -->  traveled 46 inches  -->  9.2 inches / second (probably no faster than 800)
#
...
#
#       speed_in_inches_per_second = .0112 * speed_in_degrees_per_second + 0
#
...
def main():
    ...
    while time_s != 0:
        ...
        distance_deg = distance_in / m
        time_s = distance_deg / left_sp
